...
public class SpecificBranchBuildChooser extends BuildChooser {
    @DataBoundConstructor
    public SpecificBranchBuildChooser() {
    }
    ...
    public Collection<Revision> getCandidateRevisions(boolean isPollCall, String singleBranch,
            IGitAPI git, TaskListener listener, BuildData data, BuildChooserContext context)
    ...
    public static final class DescriptorImpl extends BuildChooserDescriptor {
        ...
        public String getDisplayName() {
            return "BuildChooser_SpecificBranch";
        }
